...
def create_array_ids(x):
    '''
    Ningqiao add: this function returns the array to match the actual and counterfactual
    matched pairs given the real id of buyers and targets.
...
def create_x(merger_df, id_array):
    '''
    Ningqiao added: This function returns the dataframe for evaluation given the matches and counterfactual
    pairs and corresponding characteristics.
...
def payoff_without_transfers(df, parameters):
    '''
    Ningqiao added: This function returns the payoff without transfers given the variable parameters in model 1.
...
def payoff(data, parameters):
    '''
    Ningqiao added: this function returns the payoff to the merger given the value of alpha and beta parameters in
    model 1.
...
def payofftransfers(data, parameters):
    '''
    Ningqiao added: this function returns the payoff to the merger given the value of parameters in model 2.
    Args:
